...
for required in go.mod go.sum LICENSE cmd/slack-agent-cli/main.go assets/skills/slack/SKILL.md; do
...
actual_assets=$(find "$output_dir" -mindepth 1 -maxdepth 1 -type f -print |
  wc -l | tr -d ' ')
